               ...
               <section className="page-section" id="contact">
                    <div className="container">
                         ...
                         <form id="contactForm" name="sentMessage" noValidate="novalidate">
                                   ...
                                   <div className="col-md-6">
                                        <div className="form-group">
                                             <input className="form-control" id="name" type="text" placeholder="Your Name *" required="required"
                                                  ...
                                                  onChange={(e) => this.setState({ name: e.target.value })} data-validation-required-message="Please enter your name." />
                              ...
                              <div className="text-center">
                                   <div id="success"></div>
                                   <button className="btn btn-primary btn-xl text-uppercase" id="sendMessageButton" type="submit" onClick={this.submitForm}>Send Message</button>
                              </div>
                         </form>
                    </div>
               </section>
